...
class _BreakfastPageState extends State<BreakfastPage> {
  ...
  @override
  Widget build(BuildContext context) {
    return CategoryItemPage(meals: meals);
  }
}

class CategoryItemPage extends StatefulWidget {
  const CategoryItemPage({super.key, required this.meals});
...
class _CategoryItemPageState extends State<CategoryItemPage> {
  ...
  void _navigateToCategory(int index) {
    ...
    if (index == 1) {
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const LunchPage()));
    }
